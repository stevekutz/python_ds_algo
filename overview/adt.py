...
##################################################################
## Counter is a dict subclas with keys that are hashable obj


# Initialize Counter by passing in seq obj
print(collections.Counter("this is a the way it works"))
# Counter({' ': 6, 't': 3, 'i': 3, 's': 3, 'h': 2, 'a': 2, 'w': 2, 'e': 1, 'y': 1, 'o': 1, 'r': 1, 'k': 1})

count_1 = collections.Counter("this is a the way it works")
print(count_1)

# Initialize Counter by passing in dict
dict_6 = {'One': '1', 'Two': '2', 'three': '3', 'four': '4'}
count_2 = collections.Counter(dict_6)
print(count_2)

# Initialize Counter by passing in tuple
count_3 = collections.Counter(a = 1, b = 2, c = 3)
print(f' count_3 is  {count_3}')    # count_3 is  Counter({'c': 3, 'b': 2, 'a': 1})

# Create empty Counter obj
count_4 = collections.Counter()
print(count_4)

# update values
count_4.update("this just works like it should")
print(count_4)
# Counter({' ': 5, 's': 4, 't': 3, 'i': 3, 'h': 2, 'u': 2, 'o': 2, 'k': 2, 'l': 2, 'j': 1, 'w': 1, 'r': 1, 'e': 1, 'd': 1})

# modify values
count_4[' '] = 10
count_4['s'] = 100
print(count_4)
# Counter({'s': 100, ' ': 10, 't': 3, 'i': 3, 'h': 2, 'u': 2, 'o': 2, 'k': 2, 'l': 2, 'j': 1, 'w': 1, 'r': 1, 'e': 1, 'd': 1})

# use update to add to several values, NOTE what happens to `t`
count_4.update({'s':20, ' ':40, 't':-60})
print(count_4)
# Counter({'s': 120, ' ': 50, 'i': 3, 'h': 2, 'u': 2, 'o': 2, 'k': 2, 'l': 2, 'j': 1, 'w': 1, 'r': 1, 'e': 1, 'd': 1, 't': -57})

# only show positive count values, sorted is added since `elements` does not always return in order
# count_3 is  Counter({'c': 3, 'b': 2, 'a': 1})
print(sorted(count_3.elements()))   # ['a', 'b', 'b', 'c', 'c', 'c']

# most_common
print(count_3.most_common())    # [('c', 3), ('b', 2), ('a', 1)]

# `subtract` reduces count values
print(count_3.subtract({'c': 2}))   # None
print(count_3)    # Counter({'b': 2, 'a': 1, 'c': 1})